...
import { getYoutubeThumbnailURLFromID, isValidEdit } from '../utils';
   ...
   return (
      <Wrapper wrapTarget="playlist-editor-wrapper" index={props.index}>
         <div id="playlist-editor">
            <IconedButton iconName="arrowLeft" className="button-back" onClick={() => popDisplayWithAnimation(dispatch)} />
...
const EditableVideoDisplay: React.FC<EditableVideoDisplayPropType> = (props) => {
   ...
   const handleBlurUrlInput = async (e) => {
